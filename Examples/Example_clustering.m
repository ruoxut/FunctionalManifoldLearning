...
% Author: Ruoxu Tan; date: 2022/Oct/5; Matlab version: R2024b.
...
p_obs = 60; % Numbers of observations per individual
...
[ D_FPTU_res,~ ] = FPTU( t,X,K,K,d_est,1 ); % Perform the functional parallel transport unfolding.
...
fprintf('The adjusted Rand index of the standard k-means clustering is %0.2f.',ADI_st);
