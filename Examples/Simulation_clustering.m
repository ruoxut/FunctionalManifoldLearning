%% The file reproduces the simulation of clustering in Tan et al. (2024).
...
model_opt = 1; % Selection of the model, 1:3 corresponds to model (i) to (iii) in the paper.
...
for ind_1 = 1:length(n_all)
    ...
    fname = sprintf('(%d)n%dR%d_dtrue_220310',model_opt,n,R);
